...
public final class GFSSupplyService extends AbstractSupplyService implements SupplyService {
    ...
    private static final int OFFER_PRODUCT_NAME = 1;
    private static final int OFFER_MEASURE = 2;
    ...
    public GFSSupplyService(final CompanyCointainer companyCointainer, final String user) {
