...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://AdamSobieraj.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("adam.sobieraj@op.pl");
        driverTrello.findElement(By.id("password")).sendKeys("*****S");
